...
<div class="modal fade bd-example-modal-lg modalcreate" data-backdrop="static" data-keyboard="false"
    style="z-index: 1041" tabindex="-1" id="myModalstout" role="dialog">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title">Stock Out (NEW)</h4>
            ...
            <div class="row">
                <div class="col">
                            ...
                            <div class="form-row">
                                <div class="col-6 mb-6">
                                    <div class="form-group">
                                        <label>Date</label>
                                        <input type="hidden" name="input_by" class="form-control" value="{{auth()->user()->name}}">
                                        <input type="date" name="date" id="date1" class="form-control" placeholder="Date">
                                    </div>
                                </div>
                                <div class="col-6 mb-6">
                                    <div class="form-group">
                                        <label>No Permintaan</label>
                                        <input type="text" name="no_perm" id="no_perm" class="form-control" placeholder="No Transaction">
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-12">
                                    <div class="datatable datatable-primary">
                                        <div class="table-responsive">
                                            <table id="tbl-st-out" class="table table-bordered table-hover"
                                                width="100%">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <th width="2%">
                                                            ...
                                                            <button type="button" data-toggle="tooltip"
                                                                ...
                                                                class="btn btn-danger btn-xs" id="addRow1"> <i
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="button" onclick="clear_value_create_page_stout()" class="btn btn-info "
...
<script>
                    ...
                    if (section != '') {
                        ...
                        var jumlah = "jumlah" + jml_row;
                            ...
                            t.row.add( [
                                ...
                                '<a href="#" class="btn btn-xs btn-danger destroy"><i class=" fa fa-trash remove"></i></a>',
                            ] ).draw();
                    }else{
                        Swal.fire({
                        icon: 'error',
    ...
    function clear_value_create_page_stout() {
        $('#date1').val("");
        $('#no_perm').val("");
        $('#name').val("");
        $('#section').val("");
    ...
    function clear_value_store_stout() {
        $('#date1').val("");
        $('#no_perm').val("");
        $('#name').val("");
        $('#section').val("");
...
$(document).on('click', '.destroy', function () {
    var table = $('#tbl-st-out').DataTable();
    $('#tbl-st-out tbody').on('click', 'tr', function () {
