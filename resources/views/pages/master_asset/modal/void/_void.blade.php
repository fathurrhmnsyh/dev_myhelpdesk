<div class="modal fade-out bd-example-modal-lg ModalVoidMa" tabindex="-1" id="ModalVoidMa" role="dialog"
    aria-hidden="true">
            ...
            <div class="row">
                <div class="col">
                    <div class="modal-body">
                        <form id="form-ma-void" method="post" action="javascript:void(0)">
                            @csrf
                            @method('POST')
                            <input type="hidden" id="id_ppat_void" name="id_ip">
