...
<body>
    ...
    <table border="0.5" width="700px" class="table-1">
        ...
        <tr>
            ...
            <td> &nbsp;{{$data->p_merk}} {{$data->p_jenis}} {{$data->p_type}} {{$data->p_speed}} </td>
        </tr>
        <tr>
            <td width="200px">RAM</td>
            <td>&nbsp;{{$data->r_size}} GB,{{$data->r_type}}, {{$data->r_slot}} Channel</td>
        </tr>
        <tr>
            <td width="200px">Hardisk Drive</td>
            <td>&nbsp;{{$data->hd1_merk}} &nbsp;{{$data->hd1_type}} &nbsp; {{$data->hd1_size !== null? $data->hd1_size  .'GB' : ''}}
            </td>
        </tr>
        <tr>
            <td width="200px">Hardisk Drive</td>
