        ...
        <nav class="mt-2">
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
               ...
               with font-awesome or any other icon font library -->
                ...
                <li
                    class="nav-item has-treeview {{request()->is('assign_asset*','master_asset*','komputer*', 'laptop*', 'printer*', 'user_kom*', 'user_laptop*') ? 'menu-open' : ''}}">
                    <a href="#"
                        class="nav-link {{request()->is('assign_asset*','master_asset*','komputer*', 'laptop*', 'printer*', 'user_kom*' , 'user_laptop*') ? 'active' : ''}}">
                    ...
                    <ul class="nav nav-treeview ">
                        <li class="nav-item has-treeview">
                            <a href="/master_asset" class="nav-link {{request()->is('master_asset') ? 'active': ''}}">
                                <i
                                    class="far fa-circle nav-icon {{request()->is('master_asset') ? 'far fa-dot-circle': ''}}"></i>
                                <p>
                                    Master Asset
                                </p>
                            </a>
                        ...
                        <li class="nav-item has-treeview">
                            <a href="/assign_asset" class="nav-link {{request()->is('assign_asset') ? 'active': ''}}">
                                <i
                                    class="far fa-circle nav-icon {{request()->is('assign_asset') ? 'far fa-dot-circle': ''}}"></i>
                                <p>
                                    Assign Asset
                                </p>
                            </a>
